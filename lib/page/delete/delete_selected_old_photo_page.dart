...
class DeleteSelectedOldPhotosPageModel extends ChangeNotifier with ImageDeletionMixin {
...
class DeleteSelectedOldPhotosPage extends StatefulWidget {
  const DeleteSelectedOldPhotosPage({super.key});

  @override
  _DeleteSelectedOldPhotosPageState createState() => _DeleteSelectedOldPhotosPageState();
}

class _DeleteSelectedOldPhotosPageState extends State<DeleteSelectedOldPhotosPage> {
  late DeleteSelectedOldPhotosPageModel _model;
  final ScrollController _scrollController = ScrollController();

  @override
  void initState() {
    super.initState();
    _model = DeleteSelectedOldPhotosPageModel();
    _model.fetchImages();
  }
    ...
    return ChangeNotifierProvider.value(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            Consumer<DeleteSelectedOldPhotosPageModel>(
        ...
        body: Consumer<DeleteSelectedOldPhotosPageModel>(
          builder: (context, model, child) {
